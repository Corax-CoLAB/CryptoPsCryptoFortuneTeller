...
**Learning:** In complex data dashboards like this crypto circus, users are often overwhelmed by options (models, parameters). Adding simple `help` tooltips to inputs provides immediate context without cluttering the UI.
